...
class PortConfigViewController: ConfigChildViewController {
    ...
    override func viewDidLoad() {
        ...
        telemetryTypePicker = MyDownPicker(textField: telemetryTypeField, withData: [ "Disabled", "Frsky", "Hott", mspvehicle.config.isApiVersionAtLeast("1.15") ? "LTM" : "MSP", "SmartPort" ])
